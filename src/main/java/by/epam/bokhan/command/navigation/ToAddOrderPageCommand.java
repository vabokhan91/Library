...
public class ToAddOrderPageCommand extends AbstractCommand {

    public ToAddOrderPageCommand(Receiver receiver) {
        super(receiver);
    }

    public void execute(RequestContent content) throws CommandException {
        super.execute(content);
        String page = ConfigurationManager.getProperty(ADD_ORDER_PAGE);
