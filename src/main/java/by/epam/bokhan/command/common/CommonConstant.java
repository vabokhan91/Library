...
class CommonConstant {
    ...
    static final String USER_INFO_PAGE = "path.page.user_info";
    static final String IS_VALID = "isValid";
    static final String USER = "user";
    static final String ERROR_LOGIN_PASS_MESSAGE = "errorLoginPassMessage";
    static final String LOGIN_ERROR_MESSAGE = "message.loginerror";
    static final String INDEX_PAGE = "path.page.index";
    static final String EXPLICIT_USER_INFO_PAGE = "path.page.explicit_user_info";
    static final String MAIN_PAGE = "path.page.startpage";
    ...
    static final String USER_EDIT_STATUS_COMMAND = "/controller?command=to_user_edit_status";
    static final String REGISTRATION_RESULT_PAGE_COMMAND = "/controller?command=to_registration_result";
