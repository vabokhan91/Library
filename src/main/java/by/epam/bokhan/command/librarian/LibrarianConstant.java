...
class LibrarianConstant {
    ...
    static final String TO_DELETE_GENRE_PAGE_COMMAND = "/controller?command=to_delete_genre_page";
    static final String TO_DELETE_PUBLISHER_PAGE_COMMAND = "/controller?command=to_delete_publisher_page";
    static final String TO_BOOK_EDIT_STATUS_PAGE_COMMAND = "/controller?command=to_book_edit_status_page";
    static final String TO_EXECUTE_ONLINE_ORDERS_STATUS_PAGE_COMMAND = "/controller?command=to_execute_online_order_status_page";
    static final String EDIT_BOOK_PAGE = "path.page.edit_book";
    static final String TO_RETURN_BOOK_STATUS_PAGE_COMMAND = "/controller?command=to_book_return_status_page";

    private LibrarianConstant() {
