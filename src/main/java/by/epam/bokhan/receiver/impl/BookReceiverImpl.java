...
public class BookReceiverImpl implements BookReceiver {
    ...
    public void getAllBooks(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.BOOKS, books);
    ...
    public void findBook(RequestContent requestContent) throws ReceiverException {
        ...
        String queryValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.FIND_QUERY_VALUE);
        try {
    ...
    public void findBookForUser(RequestContent requestContent) throws ReceiverException {
        BookDAO bookDAO = new BookDAOImpl();
        List<Book> books = null;
        String titleValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_TITLE);
        try {
    ...
    public void getExplicitBookInfo(RequestContent requestContent) throws ReceiverException {
        ...
        String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.FOUND_BOOK, book);
            requestContent.insertParameter(ReceiverConstant.FOUND_ORDER, orders);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getBookForEditing(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.FOUND_BOOK, books);
            requestContent.insertParameter(ReceiverConstant.GENRES, genres);
            requestContent.insertParameter(ReceiverConstant.AUTHORS, authors);
            requestContent.insertParameter(ReceiverConstant.PUBLISHERS, publishers);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void editBook(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String title = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_TITLE);
            String isbn = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ISBN);
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            String pageValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_PAGES);
            String yearValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_YEAR);
            String bookDescription = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_DESCRIPTION);
            String publisherIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_PUBLISHER);
            String[] genreIdValues = (String[]) requestContent.getRequestParameterValues().get(ReceiverConstant.BOOK_GENRE);
            String[] authorIdValues = (String[]) requestContent.getRequestParameterValues().get(ReceiverConstant.BOOK_AUTHOR);
            Part bookImage = (Part) requestContent.getMultiTypeParts().get(ReceiverConstant.BOOK_IMAGE);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_BOOK_EDITED, isBookEdited);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addAuthor(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String name = (String) requestContent.getRequestParameters().get(ReceiverConstant.AUTHOR_NAME);
            String surname = (String) requestContent.getRequestParameters().get(ReceiverConstant.AUTHOR_SURNAME);
            String patronymic = (String) requestContent.getRequestParameters().get(ReceiverConstant.AUTHOR_PATRONYMIC);
            String dateOfBirthValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.DATE_OF_BIRTH);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_AUTHOR_ADDED, authorIsAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addPublisher(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String publisherNameValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.PUBLISHER_NAME);
            if (isBookPublisherValid(publisherNameValue)) {
                isPublisherAdded = bookDAO.addPublisher(publisherNameValue);
            }
            requestContent.insertAttribute(ReceiverConstant.IS_PUBLISHER_ADDED, isPublisherAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void deletePublisher(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String[] publisherIdValues = (String[]) requestContent.getRequestParameterValues().get(ReceiverConstant.BOOK_PUBLISHER);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_PUBLISHER_DELETED, isPublisherDeleted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addGenre(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String genreName = (String) requestContent.getRequestParameters().get(ReceiverConstant.GENRE_NAME);
            if (isBookGenreNameValid(genreName)) {
                Genre genre = new Genre();
                genre.setName(genreName);
                isGenreAdded = bookDAO.addGenre(genre);
            }
            requestContent.insertAttribute(ReceiverConstant.IS_GENRE_ADDED, isGenreAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void deleteGenre(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_GENRE_DELETED, isGenreDeleted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void deleteAuthor(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_AUTHOR_DELETED, isAuthorDeleted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addBook(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            String publisherIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_PUBLISHER);
            String isbn = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ISBN);
            String genresIdValues[] = (String[]) requestContent.getRequestParameterValues().get(ReceiverConstant.BOOK_GENRE);
            String authorsIdValues[] = (String[]) requestContent.getRequestParameterValues().get(ReceiverConstant.BOOK_AUTHOR);
            String description = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_DESCRIPTION);
            String locationValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_LOCATION);
            Part bookImage = (Part) requestContent.getMultiTypeParts().get(ReceiverConstant.BOOK_IMAGE);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_BOOK_ADDED, isBookAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void deleteBook(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_BOOK_DELETED, isBookDeleted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addOrder(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            String librarianIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARIAN_ID);
            String libraryCardId = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARY_CARD);
            String typeOfOrder = (String) requestContent.getRequestParameters().get(ReceiverConstant.TYPE_OF_ORDER);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_ORDER_ADDED, isOrderAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void returnBook(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            String orderIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.ORDER_ID);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_BOOK_RETURNED, isBookReturned);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addOnlineOrder(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            String libraryCardValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARY_CARD);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_ONLINE_ORDER_ADDED, isOnlineOrderAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void cancelOnlineOrder(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String onlineOrderIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.ORDER_ID);
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            if (isOnlineOrderIdValid(onlineOrderIdValue) && isBookIdValid(bookIdValue)) {
                ...
                OrderStatus onlineOrderStatus = bookDAO.onlineOrderStatus(onlineOrderId).getOrderStatus();
                if (!OrderStatus.CANCELED.equals(onlineOrderStatus)) {
                    int bookId = Integer.parseInt(bookIdValue);
                    isOnlineOrderCancelled = bookDAO.cancelOnlineOrder(onlineOrderId, bookId);
                }
            }
            requestContent.insertAttribute(ReceiverConstant.IS_ONLINE_ORDER_CANCELLED, isOnlineOrderCancelled);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void executeOnlineOrder(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String onlineOrderIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.ONLINE_ORDER_ID);
            String bookIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.BOOK_ID);
            String libraryCardValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARY_CARD);
            String librarianIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARIAN_ID);
            String typeOfOrder = (String) requestContent.getRequestParameters().get(ReceiverConstant.TYPE_OF_ORDER);
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_ONLINE_ORDER_EXECUTED, isOnlineOrderExecuted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getBookByGenre(RequestContent requestContent) throws ReceiverException {
        ...
        List<Book> books = null;
        try {
            String bookGenre = (String) requestContent.getRequestParameters().get(ReceiverConstant.GENRE_NAME);
    ...
    public void getRandomBooks(RequestContent requestContent) throws ReceiverException {
        ...
        List<Book> books;
        try {
            books = bookDAO.getRandomBooks(ReceiverConstant.RANDOM_NUMBER_OF_BOOKS);
            requestContent.insertParameter(ReceiverConstant.FOUND_BOOKS, books);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
