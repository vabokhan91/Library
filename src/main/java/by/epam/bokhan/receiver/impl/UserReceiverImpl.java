...
public class UserReceiverImpl implements UserReceiver {
    ...
    public void login(RequestContent content) throws ReceiverException {
        ...
        String login = (String) content.getRequestParameters().get(ReceiverConstant.LOGIN);
        String password = (String) content.getRequestParameters().get(ReceiverConstant.PASSWORD);
        try {
            if (isLoginValid(login) && isPasswordValid(password)) {
                ...
                if (login.equals(user.getLogin()) && hashedPassword.equals(user.getPassword())) {
                    ...
                    content.insertAttribute(ReceiverConstant.USER, user);
                }
            }
            content.insertParameter(ReceiverConstant.IS_VALID, isRightData);
    ...
    public void logout(RequestContent content) {
        content.insertParameter(ReceiverConstant.INVALIDATE, ReceiverConstant.TRUE);
    }
    ...
    public void registerUser(RequestContent requestContent) throws ReceiverException {
        ...
        String name = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_NAME);
        String surname = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_SURNAME);
        String libraryCardValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARY_CARD);
        String login = (String) requestContent.getRequestParameters().get(ReceiverConstant.LOGIN);
        String password = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_PASSWORD);
        String confirmPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.CONFIRM_PASSWORD);
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_USER_REGISTERED, isUserRegistered);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void addUser(RequestContent requestContent) throws ReceiverException {
        ...
        String name = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_NAME);
        String surname = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_SURNAME);
        String patronymic = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_PATRONYMIC);
        String address = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ADDRESS);
        String roleValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ROLE);
        String login = (String) requestContent.getRequestParameters().get(ReceiverConstant.LOGIN);
        String password = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_PASSWORD);
        String confirmPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.CONFIRM_PASSWORD);
        String phone = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_MOBILE_PHONE);
        Part userPhoto = (Part) requestContent.getMultiTypeParts().get(ReceiverConstant.USER_PHOTO);
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.USER_IS_ADDED, isUserAdded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getAllUsers(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.USERS, users);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void removeUser(RequestContent content) throws ReceiverException {
        ...
        try {
            String userIdValue = (String) content.getRequestParameters().get(ReceiverConstant.USER_ID);
            if (isUserIdValid(userIdValue)) {
                int userId = Integer.parseInt(userIdValue);
                isUserDeleted = dao.removeUser(userId);
            }
            content.insertAttribute(ReceiverConstant.IS_USER_DELETED, isUserDeleted);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void findUser(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.FOUND_USER, user);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void blockUser(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            String userIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ID);
            if (isUserIdValid(userIdValue)) {
                int userId = Integer.parseInt(userIdValue);
                isUserBlocked = dao.blockUser(userId);
            }
            requestContent.insertAttribute(ReceiverConstant.IS_USER_BLOCKED, isUserBlocked);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void unblockUser(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_USER_UNBLOCKED, isUserUnblocked);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getBlockedUsers(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.BLOCKED_USERS, blockedUsers);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getNotBlockedUsers(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.NOT_BLOCKED_USERS, notBlockedUsers);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void editUser(RequestContent requestContent) throws ReceiverException {
        ...
        String patronymic = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_PATRONYMIC);
        String address = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ADDRESS);
        String role = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ROLE);
        String login = (String) requestContent.getRequestParameters().get(ReceiverConstant.LOGIN);
        String password = (String) requestContent.getRequestParameters().get(ReceiverConstant.NEW_PASSWORD);
        String confirmPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.CONFIRM_PASSWORD);
        String phone = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_MOBILE_PHONE);
        Part userPhoto = (Part) requestContent.getMultiTypeParts().get(ReceiverConstant.USER_PHOTO);
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_USER_EDITED, isUserEdited);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void changePassword(RequestContent requestContent) throws ReceiverException {
        ...
        String libraryCardValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.LIBRARY_CARD);
        String oldPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.OLD_PASSWORD);
        String newPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.NEW_PASSWORD);
        String confirmPassword = (String) requestContent.getRequestParameters().get(ReceiverConstant.CONFIRM_PASSWORD);
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.IS_PASSWORD_CHANGED, isPasswordChanged);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void changeLogin(RequestContent requestContent) throws ReceiverException {
        ...
        String userIdValue = (String) requestContent.getRequestParameters().get(ReceiverConstant.USER_ID);
        String newLogin = (String) requestContent.getRequestParameters().get(ReceiverConstant.NEW_LOGIN);
        try {
            if (isUserIdValid(userIdValue) && isLoginValid(newLogin)) {
                int userId = Integer.parseInt(userIdValue);
                isLoginChanged = dao.changeLogin(userId, newLogin);
            }
            requestContent.insertAttribute(ReceiverConstant.IS_LOGIN_CHANGED, isLoginChanged);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void uploadUserPhoto(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            if (isUserIdValid(userIdValue) && userPhoto != null) {
                ...
                if (isPhotoUploaded) {
                    ((User) requestContent.getSessionAttributes().get(ReceiverConstant.USER)).setPhoto(convertedPhoto);
                }
            }
            requestContent.insertAttribute(ReceiverConstant.IS_PHOTO_UPLOADED, isPhotoUploaded);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getUserOrders(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertAttribute(ReceiverConstant.USER_ORDERS, user);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
    ...
    public void getUserOnlineOrders(RequestContent requestContent) throws ReceiverException {
        ...
        try {
            ...
            requestContent.insertParameter(ReceiverConstant.USER_ORDERS, user);
        } catch (DAOException e) {
            throw new ReceiverException(e);
        }
    }
