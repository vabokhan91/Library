...
public class BookValidator {
    ...
    public static boolean isBookAuthorValid(Author[] authors) {
        boolean isBookAuthorValid = false;
        if (authors != null) {
            Pattern patternForAuthorName = Pattern.compile(REGEX_FOR_BOOK_GENRE);
            Pattern patternForAuthorSurname = Pattern.compile(REGEX_FOR_BOOK_GENRE);
            Pattern patternForAuthorPatronymic = Pattern.compile(REGEX_FOR_BOOK_GENRE);
