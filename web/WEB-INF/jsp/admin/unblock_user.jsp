...
<html lang="${language}">
<head>
    <title><fmt:message key="label.user.unblock_user" bundle="${messages}"/></title>
                    ...
                    <c:if test="${user.id!= item.id}">
                        <tr>
                            ...
                            <td><form method="post" action="/controller" accept-charset="UTF-8">
                                ...
                                <button class="btn btn-primary" type="submit" name="submit"><fmt:message key="label.user.unblock_user" bundle="${messages}"/></button>
                            </form> </td>
